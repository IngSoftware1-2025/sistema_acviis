...
import 'package:sistema_acviis/ui/views/trabajadores/modificar_lista_trabajadores_view.dart';
...
final Map<String, WidgetBuilder> routes = { 
  ...
  '/home_page/trabajadores_view/modificar_lista_trabajadores_view' : (BuildContext context) => ModificarListaTrabajadoresView(),
  '/home_page/trabajadores_view/modificar_lista_trabajadores_view/agregar_trabajador_view' : (BuildContext context) => AgregarTrabajadorView(),
  '/home_page/trabajadores_view/modificar_lista_trabajadores_view/eliminar_trabajador_view' : (BuildContext context) => EliminarTrabajadorView(),
};