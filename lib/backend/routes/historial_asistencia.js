    ...
    uploadStream.on('finish', async () => {
      try {
        ...
        if (!supabase) {
          ...
          const insertRow = {
            // enviar únicamente las columnas que realmente existen en la tabla public.historial_asistencia
            obraId: obraId,        // la columna en la tabla es "obraId" (camelCase y entre comillas)
            id_excel: fileId,      // columna creada para almacenar el id del xlsx
